...
MARKER_FILE="${MARKER_FILE:-/tmp/falcon_ee_tracking_7dof_markers.json}"
LOG_FILE="${LOG_FILE:-/tmp/falcon_ee_tracking_7dof_metrics.csv}"
SIM_STATUS_FILE="${SIM_STATUS_FILE:-/tmp/falcon_sim_status_7dof.json}"
SIM_CONTROL_FILE="${SIM_CONTROL_FILE:-/tmp/falcon_sim_control_7dof.json}"
...
"${PYTHON_BIN}" -u rl_policy/loco_manip/loco_manip_ee_tracking_7dof_test.py \
  --config="${CONFIG_PATH}" \
