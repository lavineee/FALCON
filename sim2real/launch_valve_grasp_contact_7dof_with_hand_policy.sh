...
export VALVE_GRASP_SUCCESS_REQUIRE_INDEX="${VALVE_GRASP_SUCCESS_REQUIRE_INDEX:-}"
export VALVE_GRASP_SUCCESS_REQUIRE_MIDDLE="${VALVE_GRASP_SUCCESS_REQUIRE_MIDDLE:-}"
export VALVE_GRASP_SUCCESS_REQUIRE_REAL_HAND_CONTACT="${VALVE_GRASP_SUCCESS_REQUIRE_REAL_HAND_CONTACT:-}"
...
export VALVE_TURN_HOLD_COMMAND_MODE="${VALVE_TURN_HOLD_COMMAND_MODE:-}"
export VALVE_TURN_HOLD_ANGLE_BRAKE_ENABLED="${VALVE_TURN_HOLD_ANGLE_BRAKE_ENABLED:-}"
export VALVE_TURN_SEGMENT_SETTLE_ENABLED="${VALVE_TURN_SEGMENT_SETTLE_ENABLED:-}"
export VALVE_TURN_SEGMENT_SETTLE_ERROR_DEG="${VALVE_TURN_SEGMENT_SETTLE_ERROR_DEG:-}"
export VALVE_TURN_SEGMENT_SETTLE_VEL_DEG_S="${VALVE_TURN_SEGMENT_SETTLE_VEL_DEG_S:-}"
export VALVE_TURN_SEGMENT_SETTLE_SEC="${VALVE_TURN_SEGMENT_SETTLE_SEC:-}"
export VALVE_TURN_SEGMENT_SETTLE_MAX_SEC="${VALVE_TURN_SEGMENT_SETTLE_MAX_SEC:-}"
export VALVE_TURN_COMPLETION_REQUIRE_GRASP="${VALVE_TURN_COMPLETION_REQUIRE_GRASP:-}"
export VALVE_TURN_COMPLETION_MIN_CONTACT_HEALTH_RATIO="${VALVE_TURN_COMPLETION_MIN_CONTACT_HEALTH_RATIO:-}"
export VALVE_TURN_COMPLETION_MAX_SLIP_M="${VALVE_TURN_COMPLETION_MAX_SLIP_M:-}"
export VALVE_TURN_COMPLETION_MAX_GRASP_ERROR_M="${VALVE_TURN_COMPLETION_MAX_GRASP_ERROR_M:-}"
export VALVE_TURN_COMPLETION_TIMEOUT_IS_FAILURE="${VALVE_TURN_COMPLETION_TIMEOUT_IS_FAILURE:-}"
export VALVE_CONTACT_ASSIST_RELEASE_ON_TURN_HOLD="${VALVE_CONTACT_ASSIST_RELEASE_ON_TURN_HOLD:-}"
...
export VALVE_TURN_ENTRY_MAX_CONTACT_FORCE_N="${VALVE_TURN_ENTRY_MAX_CONTACT_FORCE_N:-}"
...
float_env_overrides = {
    ...
    "valve_turn_segment_settle_s": "VALVE_TURN_SEGMENT_SETTLE_SEC",
    "valve_turn_segment_settle_max_s": "VALVE_TURN_SEGMENT_SETTLE_MAX_SEC",
...
value = os.environ.get("VALVE_TURN_HOLD_COMMAND_MODE", "")
if value:
    config["valve_turn_hold_command_mode"] = value
...
for env_key, config_key in (
    ...
    ("VALVE_GRASP_SUCCESS_REQUIRE_REAL_HAND_CONTACT", "valve_grasp_success_require_real_hand_contact"),
