...
if [[ -n "${USER_EXTRA_OVERLAY_CONFIG}" ]]; then
  EXTRA_OVERLAY_CONFIG="${TUNED_OVERLAY_CONFIG}:${VALVE_OVERLAY_CONFIG}:${USER_EXTRA_OVERLAY_CONFIG}"
else
  EXTRA_OVERLAY_CONFIG="${TUNED_OVERLAY_CONFIG}:${VALVE_OVERLAY_CONFIG}"
fi
